...
import { IcFile, IcX, IcBranch, IcPlay, IcStop, IcCommit } from './Icons';

export function TopBar({ env, onEnv, running, onRun, onCommit, dirty, tabs, activeTab, onTab, onCloseTab, branch }) {
  return (
